...
<section id="contact-page"  style="margin-top:10px;">
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-6">
				<div class="reply-form">
					...
					<!-- Post Form -->
                    <form class="form contact-us-form" name="contactform" id='contact_form' method="post"  action='/createAd'>
					<#--<form class="form contact-us-form" name="contactform" id='contact_form' method="post" onsubmit="return validate_form(this)" action='/createAd'>-->
						<div class="clearfix">
                            <div class="col-xs-6">
                                <!-- Name -->
                                <div class="form-group inner-addon left-addon">
                                    <p>Titel</p>
                                    <input type="text" name="titel" class="form-control gardener-reply-form" id="titelInput" pattern=".{2,100}" required>
                                </div>
                            </div>
                ...
                <div class="col-xs-6" style="margin-top:10px;">
                                ...
                                <div class="form-group inner-addon left-addon" >
                <p >Pries</p>
                <input type="text" name="price" class="form-control gardener-reply-form" id="priceInput" pattern=".{2,100}" required>
            </div>
        </div>
        ...
        <div class="col-xs-12" class="form-group inner-addon left-addon" style="margin-top:10px;">
                                <p >Description</p>
        <textarea rows="10" name="description" class="form-control gardener-reply-area" id="textContent"></textarea>
    </div>


    <div class="col-xs-12" style="margin-top:10px;">
        <!-- Send Button -->
        <button class="btn btn-default" type="button" onclick="checkAndSubmit()" >Create</button>
